...
>(
  (
    ...
    // Sync selectedValues with value prop if provided (controlled mode)
    useEffect(() => {
      console.log("Value prop changed:", props.value);
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                >
                  ...
                  >
                    <CheckIcon className="h-4 w-4 text-white dark:text-gray-900" />
                  </div>
